...
public final class PickCharHandler extends AbstractMaplePacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        System.out.println("PickCharHandler accessed.");
        ...
        try {
            ...
            if (channelServerIP.equals("0.0.0.0")) {
                ...
                c.getSession().write(MaplePacketCreator.getServerIP(InetAddress.getByName(channelServerIP), Integer.parseInt(LoginServer.getInstance().getIP(c.getWorld(), c.getChannel()).split(":")[1]), charId));
            }
