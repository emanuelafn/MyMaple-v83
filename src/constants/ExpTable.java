...
public final class ExpTable {
    ...
    private static final int[] cooking = {1, 8, 16, 33, 41, 56, 70, 138, 158, 179, 219, 243, 274, 292, 310, 333, 356, 412, 432, 456, 482, 497, 516, 604, 813};
...
public static final int getCookingNeededForLevel(int level) {
